...
ALLOWED_HOSTS = [
    ...
    '.vercel.app',
    '.now.sh',
    'echoga-fre9-6nqkpcpxv-ademu-abdullahadis-projects.vercel.app',
...
# Use non-manifest storage to avoid 500 errors in environments
# where collectstatic is not run (e.g. serverless deployments like Vercel).
